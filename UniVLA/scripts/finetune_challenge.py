...
if __name__ == "__main__":
    ...
    HF_HOME="/share/public/lianyaoxiu/.cache/huggingface/hub"
    VLA_PATH=f"{HF_HOME}/models--qwbu--univla-7b/snapshots/fccd974b2b2b7c3262e62b2a0f1b4a3a05bbdef3"
    LAM_PATH=f"{HF_HOME}/models--qwbu--univla-latent-action-model/snapshots/b5401d195f9f2ed443202ad1bbdf8c191b557242/lam-stage-2.ckpt"
    DATA_PATH=f"/home/lianyaoxiu/lianyaoxiu/fwd4/AgiBot-World/data/clear_the_countertop_waste"
    
    # add args
    parser.add_argument("--vla_path", type=str, default=f"{VLA_PATH}", help="Path to univla model ckpt")
    parser.add_argument("--lam_path", type=str, default=f"{LAM_PATH}", help="Path to LAM model ckpt")
    parser.add_argument("--data_root_dir", type=str, default=f"{DATA_PATH}", help="Path to dataset")
    parser.add_argument("--meta_json_dir", type=str, default=f"{DATA_PATH}", help="Path to dataset meta json")
